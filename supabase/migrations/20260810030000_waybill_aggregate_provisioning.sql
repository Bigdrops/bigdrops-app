...
-- Phase 4: Provision the waybill aggregate (blank_waybill_logs)
-- Created: 2026-08-10
--
-- Change summary:
--   1. _prov_get_template_tables()  → add 'blank_waybill_logs'
--   2. _prov_table_to_resource()    → map blank_waybill_logs → 'waybill'
--      (waybill aggregate resource already required by the permission model)
--
-- Scope guards:
...
--     human-executed migration (20260810040000).

-- ============================================================
-- 1. TEMPLATE TABLES (add blank_waybill_logs)
-- ============================================================
...
-- 2. RESOURCE MAPPING
-- ============================================================
-- blank_waybill_logs belongs to the waybill aggregate → 'waybill' resource.
-- This keeps the required permission set at waybill/* (no new permission
