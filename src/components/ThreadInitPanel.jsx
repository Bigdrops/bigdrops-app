    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-slate-800">Job Thread</p>
      ...
      {open && (
        <div className="px-5 pb-5 pt-1 space-y-4 border-t border-slate-100">
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-bold text-slate-800">Mark as Advance Invoice</p>
              <p className="text-[11px] text-slate-400 mt-0.5">This is the first payment in a multi-invoice job</p>
            </div>
            <button
              type="button"
