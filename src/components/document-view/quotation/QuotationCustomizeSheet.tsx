...
import custStyles from './QuotationCustomizeSheet.module.css'

interface QuotationCustomizeSheetProps {
  open: boolean
  onClose: () => void
  onSave: () => void
}

export default function QuotationCustomizeSheet({
  open,
  onClose,
  onSave,
}: QuotationCustomizeSheetProps) {
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        <div>
          <label className={custStyles.formLabel}>Template</label>
        ...
        <div>
          <label className={custStyles.formLabel}>Signatory</label>
          <select className={custStyles.formSelect}>
        ...
        <div>
          <label className={custStyles.formLabel}>Accent Colour</label>
        ...
        <div>
          <label className={custStyles.formLabel}>Font Family</label>
          <select className={custStyles.formSelect}>
        ...
        <div>
          <label className={custStyles.formLabel}>PDF Options</label>
