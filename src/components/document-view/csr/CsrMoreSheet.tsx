  ...
  return (
    <DocumentSheet open={open} onClose={onClose} title="More Actions">
      ...
      <Action
        ...
        desc="Update status to indicate work has started"
        icon={
      ...
      <Action
        label="Reopen Record"
        desc="Reopen record for further investigation"
        icon={
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <Action
        ...
        desc="Associate CSR with a project/site"
        icon={
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <Action
        danger
        label="Delete Record"
        desc="Permanently remove this CSR"
        icon={
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
