...
interface BoqPrimaryActionsProps {
  onGenerateQuotation: () => void
  onEdit: () => void
}

export default function BoqPrimaryActions({
  onGenerateQuotation,
  onEdit,
}: BoqPrimaryActionsProps) {
  return (
    <DocumentPrimaryActionRow>
      <DocumentPrimaryButton variant="amber" onClick={onGenerateQuotation}>
