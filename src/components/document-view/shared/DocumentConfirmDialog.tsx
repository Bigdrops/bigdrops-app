...
export default function DocumentConfirmDialog({
  ...
  const confirmButtonClass = destructive
    ...
    : 'h-10 min-w-32 rounded-[var(--bd-radius-lg)] border border-transparent bg-bd-button-primary-bg px-4 text-sm font-semibold text-bd-button-primary-text hover:bg-bd-button-primary-hover-bg disabled:border-bd-border disabled:bg-bd-surface-muted disabled:text-bd-text-muted disabled:opacity-100'
