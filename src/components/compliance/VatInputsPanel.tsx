...
export default function VatInputsPanel({ taxInputs, onInputsChanged }: VatInputsPanelProps) {
  ...
  return (
    <div className="space-y-4 pb-20">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <Label className="text-[11px] font-bold text-[hsl(var(--bd-text-muted))]">Date</Label>
                <Input
                  type="date"
                  className="h-10"
              ...
              <div className="space-y-2">
                <Label className="text-[11px] font-bold text-[hsl(var(--bd-text-muted))]">Vendor / Supplier</Label>
                <Input
                  className="h-10"
              ...
              <div className="space-y-2">
                <Label className="text-[11px] font-bold text-[hsl(var(--bd-text-muted))]">Category</Label>
                <Input
                  className="h-10"
              ...
              <div className="space-y-2">
                <Label className="text-[11px] font-bold text-[hsl(var(--bd-text-muted))]">Reference</Label>
                <Input
                  className="h-10"
              ...
              <div className="space-y-2">
                <Label className="text-[11px] font-bold text-[hsl(var(--bd-text-muted))]">Net Amount</Label>
                <NumericInput
                  className="h-10"
              ...
              <div className="space-y-2">
                <Label className="text-[11px] font-bold text-[hsl(var(--bd-text-muted))]">VAT Amount</Label>
                <NumericInput
                  className="h-10"
            ...
            <div className="mt-4 rounded-[var(--bd-radius-xl)] border border-[hsl(var(--bd-border))] bg-[hsl(var(--bd-surface-muted))] px-4 py-3">
              <div className="flex items-center justify-between gap-4">
                <div className="space-y-1">
                  <Label className="text-sm font-semibold text-[hsl(var(--bd-text))]">Recoverable VAT</Label>
                  <p className="text-xs text-[hsl(var(--bd-text-muted))]">Deduct this amount from output VAT when applicable.</p>
                </div>
                <Switch
      ...
      <div className="mt-6 rounded-[var(--bd-radius-xl)] border border-[hsl(var(--bd-border))] bg-[hsl(var(--bd-surface))] p-5 shadow-sm">
        <div className="flex items-start gap-3">
          <Info className="mt-0.5 h-5 w-5 shrink-0 text-[hsl(var(--bd-status-info-text))]" />
          <div>
            <div className="text-sm font-bold text-[hsl(var(--bd-text))]">Understanding VAT Inputs</div>
            <p className="mt-1 max-w-2xl text-xs leading-relaxed text-[hsl(var(--bd-text-muted))]">
