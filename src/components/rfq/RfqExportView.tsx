...
import { TableDocumentExportSegment } from '@/components/table-document/TableDocumentExportSegment'
...
export const RfqExportSegment: React.FC<RfqExportSegmentProps> = ({ rfq, items = [], rows, columns, onRef }) => {
  return (
