  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50/50">
      ...
      <header className="sticky top-0 z-20 bg-background/80 backdrop-blur-md border-b border-border/50 px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            disabled={saving}
            size="sm"
            className="h-9 gap-1.5 bg-slate-900 hover:bg-slate-800 text-white font-bold uppercase tracking-wider shadow-sm transition-all active:scale-[0.98]"
          >
      ...
      <main className="flex-1 flex flex-col md:flex-row h-[calc(100vh-64px)] overflow-hidden">
        ...
        {/* Preview Panel */}
        <div className={cn(
          "flex-1 overflow-y-auto bg-slate-200/50 p-4 md:p-8 flex items-start justify-center",
