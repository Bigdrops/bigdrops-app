    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        <div className="px-4 pb-7 pt-5">
          <div className="mx-auto mb-[22px] h-[5px] w-10 rounded-full bg-zinc-200" />

          <div className="mb-[22px]">
            <div className="text-sm font-medium text-zinc-500">{eyebrow}</div>
            <div className="mt-2 text-[24px] font-bold leading-[1.05] tracking-[-0.03em] text-zinc-900">{title}</div>
          ...
          {deleteAction ? (
            <button
              ...
              className="mt-[14px] flex w-full flex-col items-center gap-[10px] rounded-[16px] bg-red-100 px-4 py-[18px] text-red-800 hover:bg-red-200"
            >
