      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close data-slot="dialog-close" asChild>
            <Button
              variant="ghost"
              className="absolute top-2 right-2 bg-bd-overlay-close-bg text-bd-overlay-close-text hover:brightness-95"
              size="icon-sm"
            >
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        "text-xs/relaxed text-bd-overlay-muted *:[a]:underline *:[a]:underline-offset-3 *:[a]:hover:text-bd-overlay-text",
        className
      )}
      {...props}
    />
