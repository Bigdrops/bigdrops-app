...
export { resolveColumnStyle as resolveIndustryColumnStyle } from '../engine/resolveColumnStyle'
export { resolveTextAlignmentStyle } from '../engine/resolveTextAlignmentStyle'
