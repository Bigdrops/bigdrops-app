...
export const compactIndustry: Partial<CompactOverrides> = {
  page: { paddingTop: 16, paddingBottom: 48, paddingHorizontal: 20 },
  header: { marginBottom: 8 },
  customTitle: { marginBottom: 6 },
  metaRow: { marginBottom: 3 },
  partyRow: { marginBottom: 8 },
  partyBox: { paddingTop: 8, paddingBottom: 8, paddingHorizontal: 10 },
  partyTitle: { marginBottom: 4, fontSize: 12 },
  tableWrap: { marginBottom: 8 },
  tableHeaderCell: { paddingVertical: 4 },
  tableCell: { paddingVertical: 3, paddingHorizontal: 4 },
