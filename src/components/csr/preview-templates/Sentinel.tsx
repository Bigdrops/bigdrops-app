...
function createStyles(density = 'comfortable', designPreset: any) {
  ...
  return StyleSheet.create({
    ...
    companyTagline: { fontSize: tight ? 5.5 : 6.2, color: '#BDD8D9', textTransform: 'uppercase', marginTop: 2 },
    contactLine: { fontSize: tight ? 5.4 : 6.1, color: '#BDD8D9', marginTop: 2 },
    ...
    logoSlot: { width: 48, height: 48, borderRadius: 99, backgroundColor: GOLD, justifyContent: 'center', alignItems: 'center' },
    ...
    ackContainer: { borderWidth: 1, borderColor: '#F0E6D3', borderRadius: 6, overflow: 'hidden' },
    ackTopRow: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#F0E6D3' },
    ackTopHalf: { flex: 1, paddingTop: tight ? 2.5 : 3.5, paddingBottom: tight ? 18 : 22, paddingHorizontal: tight ? 4.5 : 5.5, borderRightWidth: 1, borderRightColor: '#F0E6D3' },
    ...
    ackRecipientSig: { width: '40%', paddingTop: tight ? 2.5 : 3.5, paddingBottom: tight ? 12 : 16, paddingHorizontal: tight ? 4.5 : 5.5, borderRightWidth: 2, borderRightColor: GOLD },
    ackTechSig: { width: '30%', paddingTop: tight ? 2.5 : 3.5, paddingBottom: tight ? 12 : 16, paddingHorizontal: tight ? 4.5 : 5.5, borderRightWidth: 2, borderRightColor: GOLD },
    ackTechName: { width: '30%', paddingTop: tight ? 2.5 : 3.5, paddingBottom: tight ? 12 : 16, paddingHorizontal: tight ? 4.5 : 5.5 },
    ackFieldLabel: { fontSize: tight ? 5.4 : 5.8, color: '#8B7355', textTransform: 'uppercase', fontFamily: 'Helvetica-Bold' },
