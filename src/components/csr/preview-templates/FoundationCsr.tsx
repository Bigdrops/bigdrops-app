...
function createFoundationStyles(density = 'comfortable', designPreset: any) {
  ...
  return StyleSheet.create({
    ...
    companyTagline: { fontSize: tight ? 5.5 : 6.2, color: '#c4bfc5', textTransform: 'uppercase', marginTop: 2 },
    contactLine: { fontSize: tight ? 5.4 : 6.1, color: '#b5b0b6', marginTop: 2, lineHeight: tight ? 1.1 : 1.3 },
    idBox: {
      width: tight ? 120 : 132,
      backgroundColor: '#3d3740',
      borderWidth: 1,
      borderColor: '#6b616c',
      borderRadius: 5,
      paddingVertical: tight ? 5 : 6,
    ...
    idLabel: { fontSize: 5.8, color: '#a8a3a9', textTransform: 'uppercase', fontFamily: 'Helvetica-Bold' },
    idValue: { fontSize: 11, color: '#ffffff', fontFamily: fillableBold, marginTop: 2 },
    idDate: { fontSize: 6.5, color: '#b5b0b6', marginTop: 2, fontFamily: 'Helvetica-Bold' },
    ...
    readingLabel: { fontSize: 5.4, color: '#b5b0b6', textTransform: 'uppercase', marginTop: 2, fontFamily: 'Helvetica-Bold' },
...
export function FoundationCsrTemplate({ csr, comments, branding, designPreset }: CsrPdfProps) {
  ...
  const styles = createFoundationStyles(layoutDensity, designPreset)
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <View style={styles.headerTop}>
            <View style={styles.brandBox}>
              <PdfLogoSlot styles={styles} branding={branding} fallback="F" />
        ...
        {hasMaterials(csr) ? (
          <MaterialsSection styles={styles} csr={csr} templateId="foundation" preferredStyle={tightLayout ? 'comma' : 'list'} />
        ) : null}
