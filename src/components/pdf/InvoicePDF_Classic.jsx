...
const A = '#0F172A' // accent — navy

const s = StyleSheet.create({
  page: { fontFamily: 'Helvetica', fontSize: 10, padding: 40, backgroundColor: 'white' },

  // Header
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', paddingBottom: 16, marginBottom: 20, borderBottomWidth: 2, borderBottomColor: A },
  companyBlock: { flex: 1, marginRight: 20 },
  logo: { maxWidth: 110, maxHeight: 55, marginBottom: 6, objectFit: 'contain' },
  companyName: { fontSize: 14, fontFamily: 'Helvetica-Bold', color: A, marginBottom: 2 },
  companyDetail: { fontSize: 8, color: '#64748B', marginBottom: 1 },
  docBlock: { alignItems: 'flex-end' },
  docTitle: { fontSize: 22, fontFamily: 'Helvetica-Bold', color: A, marginBottom: 4, letterSpacing: 1 },
  docNumber: { fontSize: 11, fontFamily: 'Helvetica-Bold', color: A, marginBottom: 2 },
  docDate: { fontSize: 9, color: '#64748B', marginBottom: 1 },
  ...
  invoiceTitle: { fontSize: 13, fontFamily: 'Helvetica-Bold', color: A, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  groupSubtotalRow: { flexDirection: 'row', justifyContent: 'flex-end', paddingVertical: 4, paddingHorizontal: 8, backgroundColor: '#f0f0f0', borderBottomWidth: 1, borderBottomColor: '#ddd' },
  ...
  // Columns — Make is now a proper separate column
  ...
  amountWords: { backgroundColor: '#f9f9f9', padding: 8, marginBottom: 12, borderLeftWidth: 3, borderLeftColor: A },
...
export default function InvoicePDF_Classic({ invoice, items = [], client, settings = {} }) {
  ...
  // Check if any item has a make value
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.header}>
          ...
          <View style={s.docBlock}>
            ...
            {invoice.invoice_title ? <Text style={[s.docDate, { fontFamily: 'Helvetica-Bold', fontSize: 10, color: '#334155', marginBottom: 4 }]}>{invoice.invoice_title}</Text> : null}
        ...
        <View style={s.table}>
          ...
          {d.renderRows.map((row, ri) => {
            if (row._type === 'group_header') return (
              <View key={'gh_' + ri} style={s.groupRow}>
