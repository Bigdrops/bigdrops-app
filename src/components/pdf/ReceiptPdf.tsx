...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20, fontFamily: 'Helvetica-Bold', textAlign: 'center', marginVertical: 10 },
  receiptMeta: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12, gap: 16 },
  metaBlock: { flex: 1 },
  metaLabel: { fontSize: 8, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 2 },
  metaValue: { fontSize: 11 },
  divider: { borderBottomWidth: 1, marginBottom: 12 },
  sectionTitle: { fontSize: 10, fontFamily: 'Helvetica-Bold', marginBottom: 6, textTransform: 'uppercase', letterSpacing: 0.5 },
  detailRow: { flexDirection: 'row', marginBottom: 4 },
  detailLabel: { width: 130, fontSize: 9 },
  detailValue: { flex: 1, fontSize: 9 },
  amountBox: { padding: 12, borderRadius: 4, marginBottom: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  ...
  notesBox: { padding: 10, borderRadius: 4, marginBottom: 12 },
  notesLabel: { fontSize: 8, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 3 },
  notesText: { fontSize: 9 },
  termsBox: { marginBottom: 14 },
  termsTitle: { fontSize: 9, fontFamily: 'Helvetica-Bold', marginBottom: 3 },
  termsText: { fontSize: 8, lineHeight: 1.4 },
  signatureRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 16, marginBottom: 14 },
  signatureBlock: { width: '45%' },
  signatureLine: { borderBottomWidth: 1, marginBottom: 4, marginTop: 14 },
  ...
  footer: { marginTop: 12, paddingTop: 10, borderTopWidth: 1, alignItems: 'center' },
