              ...
              {advanceSheetMode === 'view' && advanceInvoice ? (
                <div className="space-y-4">
                  ...
                  <div className="rounded-2xl bg-slate-950 px-4 py-4 text-white">
                    <div className="grid gap-3 sm:grid-cols-3">
                      ...
                      <MetricBlock label="This Advance" value={formatMoney(Number(advanceInvoice.total || 0))} />
                      <MetricBlock label="Balance Remaining" value={formatMoney(Math.max(0, contractValue - Number(advanceInvoice.total || 0)))} />
                    </div>
                  </div>
                </div>
              ) : (
                <>
                  ...
                  <div className="rounded-2xl bg-slate-950 px-4 py-4 text-white">
                    <div className="grid gap-3 sm:grid-cols-3">
                      <MetricBlock label="Contract Value" value={formatMoney(contractValue)} />
                      <MetricBlock label="This Advance" value={formatMoney(advanceAmount)} />
                      <MetricBlock label="Balance Remaining" value={formatMoney(balanceRemaining)} />
                    </div>
                  </div>
                </>
              )}
