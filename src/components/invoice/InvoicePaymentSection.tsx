        ...
        <CardContent className="space-y-4 p-4">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            {showRecordPaymentButton && onRecordPayment ? (
              <Button type="button" size="sm" className="bg-emerald-600 text-white hover:bg-emerald-700" onClick={onRecordPayment}>
                Record Payment
              </Button>
            ) : null}
          </div>
                  ...
                  {paymentHistory.map((payment) => {
                    ...
                    return (
                      <TableRow key={payment.id}>
                        ...
                        <TableCell className={`text-right font-semibold ${payment.runningBalance > 0 ? 'text-red-600' : 'text-emerald-600'} ${rowClassName}`}>
