...
export function DocumentActionSheet({ open, onOpenChange, title, subtitle, actions }: DocumentActionSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="bottom"
        className="flex h-[50vh] max-h-[var(--bd-overlay-sheet-max-height)] flex-col overflow-hidden rounded-t-[var(--bd-overlay-radius)] px-0 pb-4"
      >
...
export function DocumentPdfSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="h-[50vh] max-h-[var(--bd-overlay-sheet-max-height)] overflow-hidden rounded-t-[var(--bd-overlay-radius)] px-0 pb-6">
