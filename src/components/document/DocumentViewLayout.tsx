    ...
    <div className="sticky top-0 z-30 -mx-4 border-b border-[hsl(var(--bd-border))] bg-[hsl(var(--bd-surface-muted))]/95 px-4 py-3 backdrop-blur md:-mx-6 md:px-6">
      <div className="flex items-center gap-3 pl-12 md:pl-0">
        <button
          type="button"
          onClick={onBack}
          className="grid h-10 w-10 shrink-0 place-items-center rounded-2xl border border-[hsl(var(--bd-border))] bg-[hsl(var(--bd-surface))] text-[hsl(var(--bd-text-muted))] shadow-sm transition hover:bg-[hsl(var(--bd-surface-muted))]/60"
        >
...
export function DocumentHeroCard({ eyebrow, value, helper, stats = [] }: DocumentHeroCardProps) {
  return (
    <div className="overflow-hidden rounded-[26px] bg-[hsl(var(--bd-surface-muted))] p-5 text-[hsl(var(--bd-text))] shadow-[0_18px_40px_-18px_rgba(15,23,42,0.65)]">
      <div className="text-[10px] font-extrabold uppercase tracking-[0.18em] text-[hsl(var(--bd-text-muted))]">{eyebrow}</div>
      <div className="mt-2 text-[2.2rem] font-black leading-none tracking-[-0.04em]">{value}</div>
      {helper ? <div className="mt-3 text-sm leading-6 text-[hsl(var(--bd-text-muted))]">{helper}</div> : null}
      {stats.length > 0 ? (
        <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-3">
          {stats.map((stat) => (
            <div key={stat.label} className="rounded-2xl border border-[hsl(var(--bd-border))] bg-[hsl(var(--bd-surface))]/5 px-3 py-3">
              <div className="text-[9px] font-extrabold uppercase tracking-[0.16em] text-[hsl(var(--bd-text-muted))]">{stat.label}</div>
              <div className={cn('mt-1 text-base font-extrabold', stat.className || 'text-[hsl(var(--bd-text))]')}>{stat.value}</div>
            </div>
          ))}
        </div>
      ) : null}
    ...
    <div className="space-y-2">
      ...
      >
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            <div className="text-[10px] font-extrabold uppercase tracking-[0.18em] text-[hsl(var(--bd-text-muted))]">{compactLabel}</div>
            ...
            {helper ? <div className="mt-2 line-clamp-2 text-sm leading-6 text-[hsl(var(--bd-text-muted))]">{helper}</div> : null}
        ...
        return (
          <button
            ...
            className={cn(
              ...
              action.variant === 'dark' && 'border-[hsl(var(--bd-button-primary-bg))] bg-[hsl(var(--bd-button-primary-bg))] text-[hsl(var(--bd-button-primary-text))]',
        ...
        {items.map((item) => (
          <button
            ...
            className={cn(
              ...
              item.active ? 'border-[hsl(var(--bd-button-primary-bg))] bg-[hsl(var(--bd-button-primary-bg))] text-[hsl(var(--bd-button-primary-text))]' : 'border-[hsl(var(--bd-border))] bg-[hsl(var(--bd-surface))] text-[hsl(var(--bd-text-muted))]',
    ...
    <section className={cn('space-y-2', className)}>
      ...
      >
        <div className="min-w-0">
          <div className="text-[10px] font-extrabold uppercase tracking-[0.18em] text-[hsl(var(--bd-text-muted))]">{title}</div>
          {summary ? <div className="mt-1 text-sm text-[hsl(var(--bd-text-muted))]">{summary}</div> : null}
        </div>
    ...
    <Card className="overflow-hidden rounded-[26px] border-[hsl(var(--bd-border))] bg-[hsl(var(--bd-surface))] shadow-sm">
      <CardContent className="p-0">
        <div className="flex items-center justify-between gap-3 px-3 py-3 sm:px-4">
          <div className="text-[10px] font-extrabold uppercase tracking-[0.18em] text-[hsl(var(--bd-text-muted))]">Preview</div>
        ...
        <div className="overflow-hidden border-t border-[hsl(var(--bd-border))] bg-[hsl(var(--bd-surface))] sm:mx-2 sm:mb-2 sm:rounded-[24px] sm:border sm:shadow-[0_18px_34px_rgba(15,23,42,0.08)]">
          ...
          <div className="space-y-5 px-3 py-4 sm:px-5 sm:py-6">
            <div className="space-y-4 border-b border-[hsl(var(--bd-border))] pb-5">
              <div className="space-y-2">
                ...
                <div className="break-words text-[2rem] font-black leading-none tracking-[-0.05em] text-[hsl(var(--bd-text))]">{documentNumber || documentLabel}</div>
              </div>
              ...
              <div className="space-y-4 sm:grid sm:grid-cols-[minmax(0,1fr)_minmax(0,0.88fr)] sm:gap-4 sm:space-y-0">
                <div className="min-w-0 space-y-2">
                  ...
                  <div className="break-words text-base font-bold text-[hsl(var(--bd-text))]">{companyName || documentLabel}</div>
                ...
                <div className="min-w-0 rounded-[20px] bg-[hsl(var(--bd-surface-muted))] px-4 py-4">
                  ...
                  <div className="mt-2 break-words text-base font-bold text-[hsl(var(--bd-text))]">{recipientName || 'Unassigned'}</div>
            ...
            <div className="space-y-3 border-b border-[hsl(var(--bd-border))] pb-5">
              ...
              {previewItems.length > 0 ? (
                <div className="space-y-3">
                  {previewItems.map((item, index) =>
                    isGroupPreviewItem(item) ? (
                      <div key={`${item.label}-${index}`} className="rounded-[18px] bg-[hsl(var(--bd-surface-muted))] px-4 py-3 text-[11px] font-extrabold uppercase tracking-[0.16em] text-[hsl(var(--bd-text-muted))]">
                        {item.label}
                      </div>
                    ) : (
                ...
                <div className="rounded-[18px] border border-dashed border-[hsl(var(--bd-border))] bg-[hsl(var(--bd-surface-muted))] px-4 py-4 text-sm text-[hsl(var(--bd-text-muted))]">
                  No line items.
                </div>
              )}
            </div>
                ...
                {totals.map((row) => (
                  <div
                    ...
                    className={cn(
                      ...
                      row.emphasis ? 'bg-[hsl(var(--bd-button-primary-bg))] text-[hsl(var(--bd-button-primary-text))]' : 'bg-[hsl(var(--bd-surface-muted))] text-[hsl(var(--bd-text))]',
                    )}
                  >
                    <span
                      className={cn(
                        row.emphasis ? 'font-bold text-[hsl(var(--bd-button-primary-text))]' : 'font-medium text-[hsl(var(--bd-text-muted))]',
                        row.labelClassName,
                      )}
                    >
                      {row.label}
                    ...
                    <span
                      className={cn(
                        'text-right',
                        row.emphasis ? 'font-extrabold text-[hsl(var(--bd-button-primary-text))]' : 'font-bold text-[hsl(var(--bd-text))]',
                        row.valueClassName,
                      )}
                    >
                      {row.value}
  ...
  return (
    <Card className="rounded-[22px] border-border shadow-sm">
      <CardContent className="px-4 py-1.5">
        {rows.map((row) => (
          <div key={row.label} className="flex items-start justify-between gap-4 border-b border-[hsl(var(--bd-border))] py-3 last:border-b-0">
            <div className="text-[10px] font-extrabold uppercase tracking-[0.14em] text-[hsl(var(--bd-text-muted))]">{row.label}</div>
          ...
          {rows.map((row) => (
            <div
              ...
              className={cn(
                ...
                row.divider && 'border-t border-[hsl(var(--bd-border))] pt-3',
              )}
            >
...
export function DocumentBottomBar({ actions }: DocumentBottomBarProps) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-20 bg-gradient-to-t from-[hsl(var(--bd-surface-muted))] via-[hsl(var(--bd-surface-muted))]/95 to-transparent px-4 pb-5 pt-4 md:px-6">
      <div className="mx-auto max-w-3xl rounded-[24px] border border-[hsl(var(--bd-border))] bg-[hsl(var(--bd-surface))]/98 p-2 shadow-[0_-16px_34px_-26px_rgba(15,23,42,0.52)] backdrop-blur">
