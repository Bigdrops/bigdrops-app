  ...
  return (
    <span
      className={[
        ...
        active ? 'bg-bd-status-warning-bg shadow-sm' : 'bg-bd-text-muted',
      ].join(' ')}
      aria-hidden="true"
    />
  )
      ...
      <div className="flex items-start justify-between gap-3 leading-snug">
        <div className="flex min-w-0 flex-col gap-1">
          <div className="flex items-center gap-[6px]">
            ...
            <span className="truncate text-[13px] font-bold leading-tight text-bd-text">{item.name}</span>
          </div>
          
          <div className="flex items-center gap-1.5 overflow-hidden whitespace-nowrap text-[11px] text-bd-text-muted">
            <span className="font-['JetBrains_Mono'] text-bd-text-muted/80">
            ...
            <span className="text-bd-border">·</span>
        ...
        <div className="flex flex-col items-end gap-1.5">
          <span className="font-['JetBrains_Mono'] text-[13px] font-bold text-bd-text">
          ...
          {isFlagged && (
            <button
              ...
              className="flex-shrink-0 rounded-[var(--bd-radius-sm)] bg-bd-status-warning-bg px-[5px] py-[1.5px] text-[9px] font-bold uppercase tracking-wider text-bd-status-warning-text border border-bd-status-warning-border transition-colors hover:opacity-80"
            >
              Review
            </button>
          )}
