...
export default function WorkspaceCreation() {
  ...
  // This screen renders only when the user has no active workspace and no
  // visible pending invitation, so present the explicit Create-vs-Join
  // choice. Nothing is created on mount: the user picks Create (with their
  // own workspace name) or Join (invitation workflow).
