...
export const invoiceImportPrompt = `Convert the source content into JSON for invoice import.
...
export const invoiceUpdateTablePrompt = `Convert the source content into JSON for invoice table update.
...
export const invoiceImportAdapter = {
  ...
  prompts: {
    'Create Rows': invoiceImportPrompt,
    'Update Table': invoiceUpdateTablePrompt,
  },
