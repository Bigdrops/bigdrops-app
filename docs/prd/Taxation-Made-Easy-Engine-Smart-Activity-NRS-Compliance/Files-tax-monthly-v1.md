...
| 7 | Small-business exemption | NTAA §22(4) exempts a small business from the monthly VAT return rule in §22(1). Confirm whether the tenant qualifies, because the exemption changes the return deadline line. | The VAT return deadline line for qualifying tenants |
...
| VAT return deadline, 21st | NTAA §22(1) | Confirmed from primary text — NTAA §22(1) fixes the return "on or before the 21st day of the following month" (gazette A 278). Subject to the NTAA §22(4) small-business exemption (open decision 7). |
