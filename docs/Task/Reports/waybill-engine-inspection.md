...
**Zero matches in any source file.** All three names exist only in the prompt file itself (`docs/Task/Prompts/prompt705.md`, lines 16 and 22). No source file under `src/` or anywhere else in the repository exports, imports, or references these symbols.
