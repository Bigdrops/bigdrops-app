 ...
 * Item: forme/table, file registry/bases/forme/components/table/table.tsx
 * Retrieved: 2026-09-08. Only import paths were rewritten to local relatives.
 * No logic was changed.
 *
 * NOTE (POC observation, carries over from the Takumi base): this Table also
 * renders flexbox Views, not Forme's native Table/Row/Cell. Forme's engine
 * repeats native header rows automatically, but this abstraction cannot use
 * that mechanism. The POC tests both paths separately.
 */
...
import {
  Text as PDFText,
  View,
} from "./pdf-primitives.tsx";
import type { Style } from "./pdf-primitives.tsx";
