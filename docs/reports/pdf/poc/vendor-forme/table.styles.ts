 ...
 * Item: forme/table, file registry/bases/forme/components/table/table.styles.ts
 * Retrieved: 2026-09-08. Only import paths were rewritten.
 * No logic was changed. (Token values are identical to the Takumi copy;
 * the StyleSheet import targets @formepdf/react here.)
 */
