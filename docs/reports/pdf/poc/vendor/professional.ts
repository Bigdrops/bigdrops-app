/**
 * POC VENDOR FILE — verbatim tokens from pdfcn upstream.
 * Source: https://pdfcn.dev/r/theme-professional.json
 * Item: theme-professional, file registry/themes/professional.ts
