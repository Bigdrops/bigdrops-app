 ...
 * Source: https://pdfcn.dev/r/takumi/table.json
 * Item: takumi/table, file registry/bases/takumi/components/table/table.tsx
 * Retrieved: 2026-09-07. Only import paths were rewritten to local relatives.
 * No logic was changed.
 *
 * NOTE (POC observation, not upstream): this Table renders flexbox Views,
 * not an HTML <table>. Takumi's <thead> repeat mechanism therefore does not
 * apply to it. The POC tests this empirically.
 */
