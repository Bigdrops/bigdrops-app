 ...
 * Source: https://pdfcn.dev/r/takumi/text.json
 * Item: takumi/text, file registry/bases/takumi/components/text/text.tsx
...
import type { PDFComponentProps } from "./pdf-theme-types.ts";
