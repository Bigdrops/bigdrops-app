...
**Corrective evidence:** `docs/Tickets/telegram/desktop vercel.png` (the desktop screenshot) shows the Vercel Environment Variables ledger for `bigdrops-app` with:
