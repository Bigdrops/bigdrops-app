...
| Error evidence | `docs/tickets/audit-trail/csr-audit-rpc.md:10` — PGRST202 |
...
| Error evidence | `docs/tickets/audit-trail/waybill-audit-rpc.md:23` — PGRST202 |
| Hint from PostgREST | "Perhaps you meant to call the function public.record_invoice_created" |
| Status | Function does not exist in production schema cache |
...
| Error evidence | `docs/tickets/audit-trail/csr-audit-rpc.md:2` and `waybill-audit-rpc.md:15` — HTTP 400 |
